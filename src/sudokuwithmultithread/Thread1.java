...
/*
    bu thread sudokuyu sağ alttan başlayıp satır satır gezerek
...
public class Thread1 extends Thread{
    ...
    public Thread1(String name, int dizi[][], ThreadManager threadManager) throws FileNotFoundException, UnsupportedEncodingException, IOException{
        this.dizi = dizi;
        writer = new PrintWriter("thread1.txt", "UTF-8");
    ...
    public Lokasyon bosKutucukBul(int dizi[][]){
        for(xler = 8; xler >= 0; xler--){
            for(yler = 8; yler >= 0; yler--){
                if(dizi[xler][yler] == 0){
